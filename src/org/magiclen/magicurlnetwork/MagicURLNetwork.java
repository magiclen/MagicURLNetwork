...
public abstract class MagicURLNetwork {
	...
	try {
		...
		doSendConnection(conn, listener, getParameters(), bosConn);
	    }
	    if (conn.getDoInput()) {
		...
		doReceiveConnection(conn, listener, bisConn, bufferedOutputStream);
	    }
     ...
     * @throws Exception 拋出例外
     */
    protected abstract void doSendConnection(final URLConnection conn, final NetworkListener listener, final HashMap<String, Body> parameters, final BufferedOutputStream bosConn) throws Exception;
     ...
     * @throws Exception 拋出例外
     */
    protected abstract void doReceiveConnection(final URLConnection conn, final NetworkListener listener, final BufferedInputStream bisConn, final BufferedOutputStream bos) throws Exception;
